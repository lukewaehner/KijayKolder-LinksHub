...
const LinksSection: React.FC<LinksSectionProps> = ({ links, isActive }) => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center h-full w-full max-w-md mx-auto relative z-10">
        ...
        >
          <div className="border border-[#2A2A2A] bg-[#0A0A0A]/80 px-3 py-2 backdrop-blur-sm">
            <p className="text-xs font-mono text-[#555555] uppercase tracking-wider">
              SWIPE_UP &gt; CONTACT_SYS
            </p>
          </div>
        </motion.div>
