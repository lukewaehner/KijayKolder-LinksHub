...
import { Link as LinkType } from "@/lib/dataService";
...
const ContactSection: React.FC<ContactSectionProps> = ({ links, isActive }) => {
      ...
      <div className="flex flex-col items-center justify-center h-full w-full max-w-md mx-auto relative z-10">
        ...
        >
          <div className="border border-[#2A2A2A] bg-[#0A0A0A]/90 px-4 py-2 backdrop-blur-sm">
            ...
            <h2
              className={`text-lg md:text-xl font-mono font-bold uppercase tracking-wider text-center ${
                isActive ? "text-[#F0F0F0]" : "text-[#555555]"
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs font-mono text-[#555555] mt-1">
                          PROTOCOL: {link.platform.toUpperCase()}
                        </div>
                      </div>
        ...
        <motion.div
          ...
          className="mt-6 text-center relative z-20 w-full"
          initial={{ opacity: 0, y: 20 }}
          transition={{ duration: 0.5, delay: 0.6, ease: "linear" }}
        >
          <div className="border border-[#2A2A2A] bg-[#0A0A0A]/90 px-4 py-3 backdrop-blur-sm">
            {/* Terminal header for business */}
            <div className="flex justify-between items-center border-b border-[#2A2A2A] pb-1 mb-2">
              <span className="text-xs font-mono text-[#F0F0F0]">
                &gt; BUSINESS_PROTOCOL
              </span>
            ...
            <div className="space-y-2">
              <p className="text-sm font-mono text-[#F0F0F0] uppercase tracking-wider">
                BOOKING &amp; BUSINESS_INQUIRIES
              </p>
              <div className="border border-[#333333] bg-[#1A1A1A] px-3 py-2">
                <p className="text-xs font-mono text-[#8B0000] uppercase tracking-wider">
                  contact@kijaykolder.com
                </p>
              </div>
              <div className="text-xs font-mono text-[#555555] mt-2">
                STATUS: MONITORING_INBOX
              </div>
            </div>
          </div>
        </motion.div>
